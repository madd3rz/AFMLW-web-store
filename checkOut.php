    ...
    <div class="container">
        ...
        <form class="checkOutReceiverInformation" action="payment-submit.php" method="post" name="checkout" onsubmit="chkcc()">
            ...
            <div>
                ...
                <input id="bankName" name="bank_name" required type="text">
            </div>
            <br>
            <div>
                <label for="bankNo">Card Number : </label>
                <input id="bankNo" name="card_number" required type="text">
            </div>
            <br>
            <div>
                <label for="bankCRC">Card CRC : </label>
                <input id="bankCRC" name="card_crc" required type="password">
            </div>
